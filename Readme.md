...
# Parsing + Configuration Script – TDV - Rev. A

This **Parsing + Configuration** script is designed for the **TDV** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TDV Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TDV** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
